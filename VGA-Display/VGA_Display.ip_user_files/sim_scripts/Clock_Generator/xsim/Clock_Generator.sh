...
#
# Generated by Vivado on Sun Apr 12 16:38:32 +0100 2020
...
# Script info
echo -e "Clock_Generator.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Clock_Generator xil_defaultlib.Clock_Generator xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Clock_Generator -key {Behavioral:sim_1:Functional:Clock_Generator} -tclbatch cmd.tcl -log simulate.log
}
