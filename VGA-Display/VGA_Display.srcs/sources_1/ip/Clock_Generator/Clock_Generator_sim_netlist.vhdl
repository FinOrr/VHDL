...
--               c:/Users/user/VGA_Display/VGA_Display.srcs/sources_1/ip/Clock_Generator/Clock_Generator_sim_netlist.vhdl
...
architecture STRUCTURE of Clock_Generator_Clock_Generator_clk_wiz is
  ...
  signal i_XTAL_Clock_Generator : STD_LOGIC;
  signal o_25MHz_Clock_Generator : STD_LOGIC;
  signal o_74MHz_Clock_Generator : STD_LOGIC;
...
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => i_XTAL,
      O => i_XTAL_Clock_Generator
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => o_74MHz_Clock_Generator,
      O => o_74MHz
    );
clkout2_buf: unisim.vcomponents.BUFG
     port map (
      I => o_25MHz_Clock_Generator,
      O => o_25MHz
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKIN1 => i_XTAL_Clock_Generator,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => o_74MHz_Clock_Generator,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => o_25MHz_Clock_Generator,
